...
EXCLUSION_RULES = {
    ...
    "8486": {
        "keywords": ["글래스 코어", "글래스 기판", "유리 기판", "tgv 기판", "tgv 글래스"],
        "exclude_headings": ["7006", "8534"],
        "reason": "글래스 코어 기판은 반도체 제조용 기계(8486호)가 아니라 가공된 판유리(7006호) 또는 인쇄회로(8534호)로 분류됩니다."
    },
    "8485": {
        "keywords": ["유리", "판유리", "코팅 유리", "자가세정", "플로트 판유리", "판 유리"],
        "exclude_headings": ["7005", "7007"],
        "reason": "판유리 및 코팅 판유리는 기계류(8485호)가 아니라 제70류(유리와 그 제품)의 제7005호 또는 제7007호로 분류됩니다."
    },
    "8479": {
        "keywords": ["유리", "판유리", "코팅 유리", "자가세정 판유리", "플로트 판유리"],
        "exclude_headings": ["7005", "7007"],
        "reason": "판유리 및 코팅 판유리는 제8479호 기계류가 아닌 제70류(유리와 그 제품)의 제7005호 또는 제7007호로 분류됩니다."
    },
    "8507": {
        "keywords": ["절연유", "냉각유", "액침", "유전체 오일"],
        "exclude_headings": ["2710", "3403", "3819"],
        "reason": "액침 냉각 절연유는 축전지 완제품/부분품(8507호)이 아니라 절연유 제2710호 또는 제3819호로 분류됩니다."
    }
}
