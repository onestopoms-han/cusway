...
import { Building2, Award, Stamp, Phone, Mail, MapPin, CheckCircle, Save, X, Eye, Sparkles, Shield, RefreshCw } from 'lucide-react';
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                  {[
                    ...
                    <button
                      key={item.key}
                      type="button"
                      onClick={() => setBranding(prev => ({ ...prev, logoIcon: item.key as any }))}
                      style={{
                        padding: '8px',
                        background: branding.logoIcon === item.key ? 'rgba(6, 182, 212, 0.2)' : '#1e293b',
                        border: branding.logoIcon === item.key ? '1.5px solid #06b6d4' : '1px solid #334155',
                        borderRadius: '6px',
                        color: branding.logoIcon === item.key ? '#38bdf8' : '#cbd5e1',
                        cursor: 'pointer',
                        fontSize: '0.75rem',
                        fontWeight: 700,
                        display: 'flex',
