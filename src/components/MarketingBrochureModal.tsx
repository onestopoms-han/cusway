        ...
        <div style={{
          ...
          <div className="brochure-printable-paper" style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <h1 style={{
                  ...
                  CUSWAY <span style={{ color: '#0284c7' }}>Customs Copilot</span>
                </h1>
                <p style={{ fontSize: '0.88rem', color: '#475569', fontWeight: 700, margin: '4px 0 0 0' }}>
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '1.25rem', fontWeight: 900, color: '#0369a1', margin: 0, lineHeight: 1.3 }}>
            ...
            <div>
              <h3 style={{ fontSize: '1.05rem', fontWeight: 900, color: '#0f172a', borderLeft: '4px solid #0284c7', paddingLeft: '8px', marginBottom: '14px' }}>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.76rem' }}>
                <thead>
                  <tr style={{ background: '#f1f5f9', borderBottom: '2px solid #cbd5e1' }}>
                    <th style={{ padding: '8px 10px', textAlign: 'left', width: '22%' }}>구분</th>
                    <th style={{ padding: '8px 10px', textAlign: 'left', color: '#dc2626', width: '39%' }}>기존 방식 (유니패스/씨엘HS)</th>
                    <th style={{ padding: '8px 10px', textAlign: 'left', color: '#0284c7', width: '39%' }}>CUSWAY AI 코파일럿</th>
                  </tr>
                </thead>
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                    <td style={{ padding: '8px 10px', fontWeight: 700, background: '#fafafa' }}>소명서 작성 시간</td>
                    <td style={{ padding: '8px 10px', color: '#64748b' }}>건당 30분 ~ 1시간 수작업</td>
                    <td style={{ padding: '8px 10px', fontWeight: 800, color: '#0284c7' }}>단 3초 만에 자동 완성 (90% 절감)</td>
                  </tr>
                  <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                    <td style={{ padding: '8px 10px', fontWeight: 700, background: '#fafafa' }}>팀 동시접속 환경</td>
                    <td style={{ padding: '8px 10px', color: '#64748b' }}>1인 1계정 선착순 튕김 발생</td>
                    <td style={{ padding: '8px 10px', fontWeight: 800, color: '#0284c7' }}>모바일/PC 무제한 동시 팀 협업</td>
                  </tr>
                  <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                    <td style={{ padding: '8px 10px', fontWeight: 700, background: '#fafafa' }}>화주 제출용 보고서</td>
                    <td style={{ padding: '8px 10px', color: '#64748b' }}>워드/한글로 매번 처음부터 작성</td>
                    <td style={{ padding: '8px 10px', fontWeight: 800, color: '#0284c7' }}>관세사 직인 A4 PDF 원클릭 발급</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '8px 10px', fontWeight: 700, background: '#fafafa' }}>지식 자산화 (캐시백)</td>
                    <td style={{ padding: '8px 10px', color: '#64748b' }}>서랍 속 방치 (0원의 가치)</td>
                    <td style={{ padding: '8px 10px', fontWeight: 800, color: '#0284c7' }}>건당 최대 5만P 캐시백 ➔ 구독료 0원</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
                ...
                <div style={{ border: '1px solid #cbd5e1', borderRadius: '8px', padding: '12px', background: '#f8fafc' }}>
                  ...
                  <div style={{ fontSize: '1.1rem', fontWeight: 900, color: '#0284c7', margin: '4px 0' }}>₩0 원 (무료)</div>
                ...
                {/* Pro Plan */}
                <div style={{ border: '2px solid #0284c7', borderRadius: '8px', padding: '12px', background: '#f0f9ff', position: 'relative' }}>
                  <span style={{ position: 'absolute', top: '-9px', right: '10px', background: '#0284c7', color: '#fff', fontSize: '0.6rem', padding: '1px 6px', borderRadius: '4px', fontWeight: 800 }}>
                    ★ 실무팀 추천
                  </span>
                  <div style={{ fontWeight: 800, fontSize: '0.85rem', color: '#0369a1' }}>Pro (실무팀형)</div>
                  <div style={{ fontSize: '1.1rem', fontWeight: 900, color: '#0284c7', margin: '4px 0' }}>월 44,000 원</div>
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center', background: '#f8fafc', padding: '6px 12px', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
                <QrCode size={36} color="#0284c7" style={{ margin: '0 auto' }} />
                <div style={{ fontSize: '0.62rem', fontWeight: 800, color: '#0f172a', marginTop: '2px' }}>
                  [무료 체험 QR코드]
                </div>
              </div>
            </div>
