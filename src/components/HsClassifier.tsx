  ...
  const runLocalHeuristicClassifier = (prod: string, mat: string, func: string): ClassificationRule => {
    ...
    if (query.includes('크랜베리') || rawQuery.includes('크랜베리') || rawQuery.includes('그랜베리') || rawQuery.includes('크렌베리') || rawQuery.includes('그렌베리') || rawQuery.includes('글랜베리') || rawQuery.includes('클랜베리') || query.includes('cranberry')) {
      if (query.includes('주스') || query.includes('juice') || query.includes('과즙') || query.includes('착즙') || query.includes('농축액')) {
        return {
          ...
          legalReasoning: "본 물품은 크랜베리 과실을 착즙하여 여과한 액상 주스로서, 발효되지 않고 주정이 첨가되지 않은 상태의 과실 주스입니다. 관세율표 일반통칙 제1호 및 제6호에 의거하여 크랜베리 주스 전용 소호인 제2009.81-0000호에 분류됩니다.",
          sectionNote: "제4부 조제 식료품",
          chapterNote: "제20류 주 제6호 (과실 주스의 정의)",
          exclusionNote: "⚠️ 주정을 함유한 과실주는 제22류로 분류됩니다.",
          headingExplanation: "제2009호 해설: 이 호에는 발효되지 않은 크랜베리 주스를 직접 분류합니다.",
          precedents: [],
          competingHsCodes: []
        };
      }
      if (query.includes('건조') || query.includes('dried') || query.includes('가당') || query.includes('설탕절임') || query.includes('조제')) {
        return {
          ...
          appliedGris: ["통칙 제1호", "통칙 제6호"],
          legalReasoning: "본 물품은 크랜베리에 설탕이나 감미료를 침지하거나 열풍 건조 등 추가 조제 공정을 거친 조제 크랜베리입니다. 관세율표 일반통칙 제1호 및 제6호에 따라 제2008.93-0000호에 확정 분류됩니다.",
          sectionNote: "제4부 조제 식료품",
          chapterNote: "제20류 채소ㆍ과실의 조제품",
          exclusionNote: "⚠️ 단순 동결 냉동 과실은 제0811.90-9000호로 분류됩니다.",
          headingExplanation: "제2008호 해설: 설탕 시럽에 절이거나 조제 가공한 크랜베리를 분류합니다.",
          precedents: [],
          competingHsCodes: []
        };
      }
      if (query.includes('신선') || query.includes('생과') || query.includes('fresh') || query.includes('생크랜베리') || query.includes('생 크랜베리') || rawQuery.includes('생그랜베리') || rawQuery.includes('생 그랜베리') || rawQuery.includes('생크렌베리') || rawQuery.includes('생 크렌베리') || rawQuery.includes('생그렌베리') || rawQuery.includes('생 그렌베리')) {
        return {
          ...
          appliedGris: ["통칙 제1호", "통칙 제6호"],
          legalReasoning: "본 물품은 수확 후 냉동·건조·가공을 거치지 않은 천연 신선 크랜베리 생과로서 제0810.40-0000호에 확정 분류됩니다.",
          sectionNote: "제2부 식물성 생산품",
          chapterNote: "제8류 식용의 과실 및 견과류",
          exclusionNote: "⚠️ 냉동 크랜베리는 제0811.90-9000호로 분류됩니다.",
          headingExplanation: "제0810호 해설: 신선 상태의 크랜베리(Vaccinium속)를 명문 분류합니다.",
          precedents: [],
          competingHsCodes: []
        };
      }
      ...
      return {
        ...
        appliedGris: ["통칙 제1호", "통칙 제6호"],
        legalReasoning: "본 물품은 수확된 크랜베리(Vaccinium속)를 세척 선별 후 급속 동결(IQF 등) 처리한 냉동 과실입니다. 관세율표 제0810호는 신선한 과실만을 분류하므로 동결 냉동된 본 물품은 제0810호에서 제외되어 제0811호에 속하며, 0811.10호(딸기), 0811.20호(라즈베리/블랙베리 등)에 해당하지 않는 크랜베리는 잔여 세번인 HSK 제0811.90-9000호(기타)에 최종 확정 분류됩니다.",
        sectionNote: "제2부 식물성 생산품",
        chapterNote: "제8류 식용의 과실 및 견과류 (신선 과실 0810호 vs 냉동 과실 0811호 구분)",
        exclusionNote: "⚠️ 신선 크랜베리는 제0810.40-0000호, 설탕침지 조제 크랜베리는 제2008.93-0000호, 크랜베리 주스는 제2009.81-0000호로 분류됩니다.",
        headingExplanation: "WCO 관세율표 해설서 제0811호: 동결 냉동된 과실을 분류하며, 0811.20호에 열거되지 않은 Vaccinium속 과실(크랜베리, 블루베리)은 0811.90호로 분류합니다.",
        precedents: [
          {
    ...
    if (isPerilla && hasPowder && (isNegatedRoasted || (!isTrulyRoasted && query.includes('분말') && !query.includes('가루')))) {
      return {
        ...
        appliedGris: ["통칙 제1호", "통칙 제6호"],
        legalReasoning: "본 물품은 열처리(볶음)를 거치지 않은 미가공 생들깨 종실을 분쇄한 생 들깨 분말(Flours and meals of oil seeds)입니다. 관세율표 일반통칙 제1호 및 제6호, 제12류 주 제2호에 의거하여, 비가열 미가공 상태의 채유용 종실 분말은 제1208호(제1208.90-9000호)에 분류됩니다. (※ 열처리 볶음 공정을 거친 식용 들깨가루는 제2008.19-9000호로 분류됩니다.)",
        sectionNote: "제2부 식물성 생산품",
        chapterNote: "제12류 주 제2호: 제1208호에는 탈지하지 않은 고운 가루와 거친 가루뿐만 아니라 일부 탈지한 것도 포함한다.",
        exclusionNote: "⚠️ 볶음 열처리를 거친 식용 볶은 들깨가루는 제2008.19-9000호로 분류되어 본 호에서 엄격히 제외됩니다.",
        ...
        competingHsCodes: [
          {
            ...
            headingName: "볶은 들깨가루",
            appliedGri: "통칙 제1호",
            reasoning: "열처리 볶음 공정을 거친 들깨가루인 경우 검토되는 세번입니다.",
    ...
    if (isPerilla && hasPowder) {
      return {
        ...
        confidence: 99,
        technicalTerms: "Perilla seed flour/powder, prepared or roasted (Perilla frutescens)",
        appliedGris: ["통칙 제1호", "통칙 제6호"],
        legalReasoning: "본 물품은 들깨 종실을 선별 세척 후 열처리 볶음(로스팅) 조제 가공을 거쳐 껍질을 탈피하거나 미세하게 분쇄한 식용 '들깨가루(조제 들깨가루)'입니다. 대한민국 관세율표 해석에 관한 일반통칙 제1호 및 제6호, 제20류 주 제1호 및 WCO 관세율표 해설서 제2008호 총설에 의거하여, 열처리 조제 가공을 거쳐 분쇄된 들깨는 채유용 미가공 종실이 분류되는 제1207호 및 미가공 분말이 분류되는 제1208호에서 배제되어 조제 식물류가 분류되는 제2008호 내 소호 제2008.19호 및 HSK 2008.19-9000(기타 조제 식물류)에 최종 분류됩니다. (기본관세율: 8%, 식약처 수입식품등의 수입신고확인증 대상)",
        ...
        exclusionNote: "⚠️ 제외규정 통제: 열처리(볶음)를 거치지 않은 천연 상태의 생들깨는 제1207.99-1000호(기본관세율 40% 또는 양허관세)로 분류되며, 참깨 전용 세번인 2008.19-3000(볶은 참깨가루)은 적용할 수 없습니다.",
        headingExplanation: "제2008호 해설: 이 호에는 볶은 땅콩, 볶은 견과류, 볶은 참깨 및 들깨가루 등 열처리 또는 기타 방법으로 조제한 식물의 부분을 분류합니다.",
        precedents: [
          {
            id: "품목분류2과-2024-0518",
        ...
        competingHsCodes: [
          ...
          },
          {
            ...
            exclusionReason: "본 물품은 들깨(Perilla)를 원료로 한 제품이므로 참깨 전용 세번인 2008.19-3000에서 배제되고 2008.19-9000에 분류됩니다."
          },
          {
            hsCode: "1208.90-9000",
            headingName: "유질 종자의 분과 밀 (미가공 생들깨 가루)",
            appliedGri: "통칙 제1호",
            reasoning: "볶지 않은 채유용 생들깨를 단순 분쇄한 경우 검토되는 세번입니다.",
            exclusionReason: "본 물품은 볶음 열처리 조제 공정을 거쳤으므로 제1208호에서 배제됩니다."
          }
        ]
      };
    }
    ...
    if (isPerilla && isTrulyRoasted) {
      return {
        ...
        appliedGris: ["통칙 제1호", "통칙 제6호"],
        legalReasoning: "본 물품은 생들깨를 열처리(볶음/로스팅)하여 원형 낟알 상태 그대로 포장한 '볶은 들깨'입니다. 관세율표 일반통칙 제1호 및 제6호에 따라 조제된 식물류가 분류되는 제2008.19-9000호(기타)에 분류됩니다.",
        sectionNote: "제4부 조제 식료품",
        ...
        competingHsCodes: [
          {
            ...
            headingName: "들깨 (생것)",
            appliedGri: "통칙 제1호",
            reasoning: "열처리가 가해지지 않은 미가공 생들깨인 경우 검토되는 세번입니다.",
    ...
    if (isPerilla) {
      return {
        ...
        appliedGris: ["통칙 제1호", "통칙 제6호"],
        legalReasoning: "본 물품은 열처리(볶음)나 조제 가공을 거치지 않은 천연 상태의 생들깨(Perilla seeds)입니다. 관세율표 일반통칙 제1호 및 제6호에 따라 채유용 종실이 분류되는 제1207호 내 소호 제1207.99-1000호(들깨)에 분류됩니다. (기본관세율: 40% 또는 양허관세 40%)",
        sectionNote: "제2부 식물성 생산품",
        chapterNote: "제12류 채유용에 적합한 종실과 과실, 각종 종실과 과실, 공업용이나 의약용 식물, 짚과 사료용 식물",
        exclusionNote: "⚠️ 열처리(로스팅/볶음) 가공된 들깨 및 들깨가루는 제2008.19-9000호로 분류되어 본 호에서 엄격히 제외됩니다.",
        headingExplanation: "제1207호에는 들깨, 참깨, 겨자씨 등 미가공 채유용 종실을 분류합니다.",
        precedents: [],
        competingHsCodes: [
          {
            hsCode: "2008.19-9000",
            headingName: "조제 들깨가루 / 볶은 들깨",
            appliedGri: "통칙 제1호",
    ...
    if (isSesame && hasPowder && (isNegatedRoasted || (!isTrulyRoasted && query.includes('분말') && !query.includes('가루')))) {
      return {
        ...
        appliedGris: ["통칙 제1호", "통칙 제6호"],
        legalReasoning: "본 물품은 열처리(볶음)를 거치지 않은 미가공 생참깨 종실을 분쇄한 참깨 분말(Flours and meals of oil seeds)입니다. 관세율표 일반통칙 제1호 및 제6호, 제12류 주 제2호에 의거하여, 비가열 미가공 상태의 채유용 종실 분말은 제1208호(제1208.90-9000호)에 분류됩니다. (※ 열처리 볶음 공정을 거친 식용 참깨가루는 제2008.19-3000호로 분류됩니다.)",
        sectionNote: "제2부 식물성 생산품",
        chapterNote: "제12류 주 제2호: 제1208호에는 탈지하지 않은 고운 가루와 거친 가루뿐만 아니라 일부 탈지한 것도 포함한다.",
    ...
    // 0-0f-1. 파쇄된 참깨 / 볶은 참깨 파쇄물 (Crushed Sesame Seeds, 1.25mm 체 통과율 95% 미만) 1207.40-0000
    if (isSesame && (query.includes('파쇄') || query.includes('부순') || query.includes('거칠') || query.includes('1.25') || query.includes('체') || query.includes('crushed') || query.includes('broken'))) {
      return {
        keywordTrigger: ['파쇄 참깨', '볶은 참깨 파쇄물', '거칠게 파쇄된 참깨', 'crushed sesame seeds', 'broken sesame'],
    ...
    // 0-0k. 냉동 해물볶음 / 조리 수산물 조제품 (1605.59-9000 / 1605.54-9000)
    if ((query.includes('해물') || query.includes('수산물') || query.includes('오징어') || query.includes('낙지') || query.includes('문어') || query.includes('조개') || query.includes('seafood')) && (query.includes('볶음') || query.includes('조리') || query.includes('양념') || query.includes('구이') || query.includes('가열') || query.includes('stir-fry') || query.includes('stir fry') || query.includes('fried'))) {
      const isSquidOnly = query.includes('오징어') && !query.includes('해물') && !query.includes('모둠');
      const isOctopusOnly = (query.includes('낙지') || query.includes('문어')) && !query.includes('해물');
      
      const targetCode = isSquidOnly ? "1605.54-9000" : (isOctopusOnly ? "1605.59-2000" : "1605.59-9000");
      const targetSubheading = isSquidOnly ? "오징어 조제품 (볶음/조리 가공품)" : (isOctopusOnly ? "낙지/문어 조제품 (볶음 가공품)" : "기타 연체동물 및 수생무척추동물 조제품 (냉동 해물볶음)");

      return {
        keywordTrigger: ['해물볶음', '냉동 해물볶음', '오징어볶음', '낙지볶음', '해물 볶음', '조리 해물', 'seafood stir fry'],
        recommendedHsCode: targetCode,
        headingName: "제1605호 (갑각류ㆍ연체동물과 그 밖의 수생 무척추동물 - 조제하거나 저장처리한 것)",
        subheadingName: `제${targetCode.slice(0, 7)}호 (${targetSubheading})`,
        confidence: 98,
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (matchedRule?.recommendedHsCode) {
                              const cleanCode = matchedRule.recommendedHsCode.replace(/[\.\-\s]/g, '');
                              navigator.clipboard.writeText(cleanCode);
                              setCopiedHsCode(true);
                              setTimeout(() => setCopiedHsCode(false), 2000);
                            }
                          }}
                          title="HSK 10단위 코드 (특수문자 제외) 클립보드 복사"
                          style={{
