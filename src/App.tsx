        ...
        <div style={{
          ...
          <div style={{ padding: isMobile ? '30px' : '50px', display: 'flex', flexDirection: 'column', gap: '24px', justifyContent: 'center' }}>
            ...
            <div style={{
              ...
              <div style={{ background: 'rgba(20, 184, 166, 0.2)', borderRadius: '10px', padding: '8px', display: 'flex', flexShrink: 0 }}>
              ...
              <div>
                <div style={{ fontSize: '0.86rem', fontWeight: 800, color: '#fff', display: 'flex', alignItems: 'center', gap: '6px' }}>
                  🎁 신규 가입 15,000P 웰컴 크레딧 증정
                </div>
                <div style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.75)', marginTop: '2px', lineHeight: 1.35 }}>
                  AI 품목분류 · 통관 요건 심사 · 세관 제출용 A4 리포트 무료 발급
                </div>
              </div>
            </div>

            {/* Social 1-Click Fast Auth CTAs */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              >
                <span style={{ fontSize: '1.1rem' }}>💬</span> 카카오로 1초 만에 시작하기
              </button>
              <p style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.5)', textAlign: 'center', margin: '0' }}>
                * 카카오 계정 연동 시 <b>1:1 실시간 관세 상담 채널</b>이 자동 연결됩니다.
              </p>
            ...
            {/* Divider */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'var(--text-muted)', fontSize: '0.72rem', margin: '4px 0 -8px 0' }}>
              <div style={{ flex: 1, height: '1px', background: 'var(--border-color)' }} />
              <span>또는 이메일 계정으로 이용</span>
              <div style={{ flex: 1, height: '1px', background: 'var(--border-color)' }} />
            </div>
