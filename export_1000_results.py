...
def run_export():
    ...
    print("=" * 80)
    print("               ONESTOP AI BATCH CLASSIFIER (1000 CASES EXPORTER)")
    print("=" * 80)
    ...
    output_csv = os.path.join(workspace_root, "onestop_1000_classification_results.csv")
    ...
    with open(output_csv, mode="w", encoding="utf-8-sig", newline="") as f:
        ...
        for idx, tc in enumerate(test_cases):
            ...
            if (idx + 1) % 100 == 0:
                print(f"Progress: {idx + 1}/1000 items processed...")

    elapsed = time.time() - start_time
    print(f"\n[SUCCESS] Exported 1000 items classification results to:")
    print(f" -> {output_csv}")
